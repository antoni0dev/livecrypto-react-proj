    ...
    <div className='flex justify-center'>
      <div className='max-w-[400px] min-h-[600px] px-4 py-20'>
        ...
        <form>
          ...
          <button className='w-full my-2 p-3 bg-button text-btnText rounded-2xl shadow-xl'>Sign un</button>
        </form>
        <p className='py-4'>Already have an account? <Link to='/signin' className='text-accent'>Sign in</Link></p>
      </div>
    </div>
  )
}
